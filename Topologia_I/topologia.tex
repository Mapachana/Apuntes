...
\begin{itemize}
\item Unión: $A\cup B=\{x\in X / x\in A o x\in B\}$.
\item Intersección: $A\cap B=\{x\in X / x\in A y x\in B\}$. Si no hay intersección se dice que es vacía, y se simboliza por $\emptyset$
